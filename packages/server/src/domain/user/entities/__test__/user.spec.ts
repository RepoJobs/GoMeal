...
describe('user unit test', () => {
  it('Should create user', () => {
    const user = new User(new Name('João', 'da Silva'), new Email('joao@teste.com'), [])
  ...
  it('Should throw error when try to create user with name as null', () => {
    expect(() => {
      const user = new User(null, new Email('joao@teste.com'), [])
  ...
  it('Should throw error when try to create user with email as null', () => {
    expect(() => {
      const user = new User(new Name('João', 'da Silva'), null, [])
